...
from mainDir.visca.dataStucture.commandData import CommandTypeEnum
from mainDir.visca.dictionary.dictionaries import genericsDictionary, systemDictionary
