from mainDir.visca.dictionary.dictionaries import systemDictionary
...
class SystemInterface(BaseInterfaceClass):
    ...
    def setHPhaseValue(self, value: int):
        ...
        return self.processor.set("system_h_phase_value", value)

    # Image Flip
    def setImageFlip(self, mode: EnableStateEnum):
        self.systemMemories.img_flip = mode
        return self.processor.set("system_img_flip", mode.value)
