...
from mainDir.visca.dictionary.dictionaries import *
from mainDir.visca.dictionary.enumerations import ExposureModeEnum, IrisSettingsEnum
from mainDir.visca.memories.colorMemories import ColorMemories
from mainDir.visca.memories.customMemories import CustomMemories
from mainDir.visca.memories.detailMemories import DetailMemories
from mainDir.visca.memories.exposureMemories import ExposureMemories
from mainDir.visca.memories.focusMemories import FocusMemories
from mainDir.visca.memories.gammaMemories import GammaMemories
from mainDir.visca.memories.genericsMemories import GenericsMemories
from mainDir.visca.memories.kneeMemories import KneeMemories
from mainDir.visca.memories.panTiltMemories import PanTiltMemories
from mainDir.visca.memories.systemMemories import SystemMemories
from mainDir.visca.memories.zoomMemories import ZoomMemories
from mainDir.visca.interfaces.colorInterface import ColorInterface
from mainDir.visca.interfaces.customInterface import CustomInterface
from mainDir.visca.interfaces.detailIInterface import DetailInterface
from mainDir.visca.interfaces.exposureInterface import ExposureInterface
from mainDir.visca.interfaces.focusInterface import FocusInterface
from mainDir.visca.interfaces.gammaInterface import GammaInterface
from mainDir.visca.interfaces.genericsInterface import GenericsInterface
from mainDir.visca.interfaces.kneeInterface import KneeInterface
from mainDir.visca.interfaces.panTiltInterface import PanTiltInterface
from mainDir.visca.interfaces.presetInterface import PresetInterface
from mainDir.visca.interfaces.systemInterface import SystemInterface
from mainDir.visca.interfaces.zoomInterface import ZoomInterface
...
class CameraObject:
    ...
    """
    def __init__(self):
        self.defaultDictionary = self.loadDictionary()
        self.initMemories()
        self.initInterfaces()
    ...
    def loadDictionary(self):
        path = os.path.join(os.path.dirname(__file__), "ViscaDictionary.json")
